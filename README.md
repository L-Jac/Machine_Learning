...
For the curious ones, the cover depicts a [hell-bender](https://en.wikipedia.org/wiki/Hellbender).

All datasets are included in the repository, except the ac lImdb dataset, which you can download from
...
You also need to install the graphic C-library, which is easiest using a package manager.
